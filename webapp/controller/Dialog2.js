sap.ui.define([
	...
	return ManagedObject.extend("com.sap.build.standard.leaveRequestAcceptDecline.controller.Dialog2", {
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.standard.leaveRequestAcceptDecline.view.Dialog2", this);
			this._bInit = false;
		},
